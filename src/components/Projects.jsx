      ...
      <div className='flex flex-wrap justify-center gap-5'>
        {PROJECTS.map((project) => (
          <motion.div
            ...
            whileHover={{ scale: 1.1, rotate: 0 }} // Rotate on hover for large screens
            whileTap={{ scale: 1.1, rotate: 0 }} // Rotate on tap for touch/small devices
            className='w-full md:w-1/2 lg:w-1/4 flex justify-center group relative overflow-hidden rounded-3xl'
          >
            <motion.img
              src={project.image}
              alt={project.name}
